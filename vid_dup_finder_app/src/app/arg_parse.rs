...
fn build_app() -> clap::Command {
    ...
    clap_app = clap_app.arg(
        clap::Arg::new(EXCL_EXTS)
            ...
            .value_delimiter(',')
            .action(Append)
            .default_value("png,jpg,bmp,jpeg,txt,text,db,gif,rb,py,mp3,wma,wav,ogg,db,flac,zip,rar,7z,pdf,htm,html,xls,doc,ppt,odt,ods,docx,xlsx,rtf,log,trashinfo,js,css,py,rs,aac,txt~,sh")
